"""titanic_survival_classification file for ensuring the package is executable
as `titanic-survival-classification` and `python -m titanic_survival_classification`
"""
import importlib
